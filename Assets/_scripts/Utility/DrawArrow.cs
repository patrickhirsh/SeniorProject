...
public static class DrawArrow
{
    ...
    public static void LineForGizmo(Vector3 start, Vector3 end, float arrowHeadLength = 0.25f, float arrowHeadAngle = 20.0f)
    {
        ...
        Gizmos.DrawLine(end, right * arrowHeadLength);
        Gizmos.DrawLine(end, left * arrowHeadLength);
    }
